...
class MXTunerController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        pieChartView.segments.append(Segment(color: .gray, value: 10, img:UIImage.init(named: "icon-1.png")!, highImg:UIImage.init(named: "icon-10.png")!))
        
        pieChartView.segments.append(Segment(color: .gray, value: 10, img:UIImage.init(named: "icon-2.png")!, highImg:UIImage.init(named: "icon-20.png")!))
        pieChartView.segments.append(Segment(color: .gray, value: 10, img:UIImage.init(named: "icon-3.png")!, highImg:UIImage.init(named: "icon-30.png")!))
        pieChartView.segments.append(Segment(color: .gray, value: 10, img:UIImage.init(named: "icon-4.png")!, highImg:UIImage.init(named: "icon-40.png")!))
        pieChartView.segments.append(Segment(color: .gray, value: 10, img:UIImage.init(named: "icon-5.png")!, highImg:UIImage.init(named: "icon-50.png")!))
        pieChartView.segments.append(Segment(color: .gray, value: 10, img:UIImage.init(named: "icon-6.png")!, highImg:UIImage.init(named: "icon-60.png")!))
        pieChartView.segments.append(Segment(color: .gray, value: 10, img:UIImage.init(named: "icon-1.png")!, highImg:UIImage.init(named: "icon-10.png")!))
        pieChartView.segments.append(Segment(color: .gray, value: 10, img:UIImage.init(named: "icon-2.png")!, highImg:UIImage.init(named: "icon-20.png")!))
        pieChartView.segments.append(Segment(color: .gray, value: 10, img:UIImage.init(named: "icon-3.png")!, highImg:UIImage.init(named: "icon-30.png")!))
        pieChartView.segments.append(Segment(color: .gray, value: 10, img:UIImage.init(named: "icon-4.png")!, highImg:UIImage.init(named: "icon-40.png")!))
